...
<body>
	<div class="form">
		...
		<form action="removedepartment.php" method="post" autocomplete="off">
			<div class="field-wrap">
				<label>Department ID<span class="req">*</span></label>
				<input type="number" min="0" required autocomplete="off" name="dept_id">
			</div>
